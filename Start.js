...
import { StyleSheet, ImageBackground, Text, TextInput, TouchableOpacity, Button, View } from "react-native";
    ...
    return (
      <ImageBackground source={require("./assets/backgroundImage.png")} style={styles.backImage}>
        ...
        <View style={styles.container}>
          ...
          <Button
            accessible={true}
            accessibilityLabel="Start chatting after you have entered a name"
            style={styles.button}
